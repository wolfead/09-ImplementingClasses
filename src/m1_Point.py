...
class Point(object):
    ...
    def __init__(self,x,y):
        ...
        self.y = y
        self.moves_made = 0
        self.dist_from_start_y = 0
        self.dist_from_start_x = 0
    ...
    def move_to(self,x,y):
        import math
        self.dist_from_start_x = self.dist_from_start_x + (x - self.x)
        self.dist_from_start_y = self.dist_from_start_y + (y - self.y)
        self.dist_traveled =  self.dist_traveled + self.get_distance_from(Point(x,y))
        self.x = x
        self.y = y
    ...
    def move_by(self,x,y):
        import math
        self.dist_traveled = self.dist_traveled + self.get_distance_from(Point(self.x + x, self.y + y))
        self.x = self.x + x
        self.y = self.y + y
        self.moves_made = self.moves_made + 1
        self.dist_from_start_y = (self.dist_from_start_y + y)
        self.dist_from_start_x = (self.dist_from_start_x + x)
    ...
    def get_distance_from_start(self):
        import math
        return math.sqrt((self.dist_from_start_x)**2 + (self.dist_from_start_y)**2)
    ...
    def closer_to(self,point2,point3):
        ...
        dist3 = self.get_distance_from(point3)
        if dist2 > dist3:
            return point3
        elif dist2 < dist3:
            return point2
